...
const About = () => {
  ...
  return (
    <section className="about section" id="about">
        ...
        <span className="section__subtitle">Yo soy una...</span>
        ...
        <div className="about__container container grid">
            ...
            <div className="about__data">
              ...
              <p className="about__description">Final year student passionate about multidisciplinary exploration, adept at integrating diverse fields and tackling challenges with dedication and a polymathic approach.</p>
              ...
              <div className={toggleState ? "cv__modal active-modal" : "cv__modal"}>
                  <div className="cv__modal-content">
                      <i className="uil uil-times cv__modal-close" onClick={toggleModal}></i>
                      <h3 className="cv__modal-title">Download CV</h3>
                      <p className="cv__modal-description">Choose the version of the CV you want to download:</p>
